...
class Ui_SecondWindow(object):
    def setupUi(self, SecondWindow):
        ...
        SecondWindow.resize(424, 201)
        self.wdgt_sw = QWidget(SecondWindow)
...
"}")
        ...
        SecondWindow.setCentralWidget(self.wdgt_sw)
    ...
    def retranslateUi(self, SecondWindow):
        SecondWindow.setWindowTitle(QCoreApplication.translate("SecondWindow", u"Vessel Analysis Program | Report", None))
